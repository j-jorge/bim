...
{
  class legacy_game_feature_button final : public ax::Node
  {
  public:
    bim_declare_widget_create_function(legacy_game_feature_button);

    legacy_game_feature_button(const bim::axmol::widget::context& context,
                        const iscool::style::declaration& style);

    ~legacy_game_feature_button();
