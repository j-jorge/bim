...
#define x_widget_scope bim::axmol::app::legacy_game_feature_button::
...
bim_implement_widget(bim::axmol::app::legacy_game_feature_button);

bim::axmol::app::legacy_game_feature_button::legacy_game_feature_button(
...
bim::axmol::app::legacy_game_feature_button::~legacy_game_feature_button() = default;

iscool::signals::connection
bim::axmol::app::legacy_game_feature_button::connect_to_clicked(
...
bim::axmol::app::legacy_game_feature_button::input_node() const
{
  return m_controls->toggle->input_node();
}

void bim::axmol::app::legacy_game_feature_button::available(bool a)
{
...
void bim::axmol::app::legacy_game_feature_button::price(int p)
{
  m_controls->price_label->setString(iscool::i18n::numeric::to_string(p));
}

void bim::axmol::app::legacy_game_feature_button::affordable(bool a)
{
  m_controls->price_label->setTextColor(a ? m_color_affordable
                                          : m_color_unaffordable);
}

void bim::axmol::app::legacy_game_feature_button::active(bool a)
{
  m_controls->toggle->set_state(a);
}

void bim::axmol::app::legacy_game_feature_button::setContentSize(const ax::Size& size)
{
...
bool bim::axmol::app::legacy_game_feature_button::init()
{
  if (!ax::Node::init())
    return false;
