  ...
  , m_feature_flags{}
{
  ...
  m_inputs.push_back(m_controls->feature_invisibility->input_node());
  ...
  connect_toggle(*m_controls->feature_invisibility,
    ...
    bim::game::feature_flags available_features)
{
  ...
  configure_feature_button(*m_controls->feature_fog_of_war,
                           *m_controls->feature_extra_1, available_features,
                           bim::game::feature_flags::fog_of_war);
  configure_feature_button(*m_controls->feature_invisibility,
                           *m_controls->feature_extra_2, available_features,
                           bim::game::feature_flags::invisibility);
}
