...
namespace bm::app::console
{
  ...
  private:
    ...
    std::unique_ptr<bm::game::contest> m_contest;
    std::unique_ptr<iscool::net::message_channel> m_game_channel;
    std::unique_ptr<bm::net::game_update_exchange> m_update_exchange;
    std::unique_ptr<bm::net::contest_runner> m_contest_runner;
