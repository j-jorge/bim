...
#include <bm/app/console/inputs.hpp>
...
bm::app::console::online_game::online_game(application& application,
                                           const std::string& host,
                                           const bm::net::game_name& name)
  ...
  , m_authentication(m_message_stream)
{
  ...
  m_authentication.connect_to_error(
      [&](bm::net::authentication_error_code error_code) -> void
      {
...
bm::app::console::online_game::~online_game() = default;

void bm::app::console::online_game::request_new_game(
    iscool::net::session_id session, const bm::net::game_name& name)
{
  m_new_game.reset(new bm::net::new_game_exchange(m_message_stream, session));
...
void bm::app::console::online_game::launch_game(
    iscool::net::session_id session, iscool::net::channel_id channel,
    unsigned player_count, unsigned player_index)
{
  m_contest.reset(new bm::game::contest(1234, 80, player_count, 13, 11));
  m_game_channel.reset(
      new iscool::net::message_channel(m_message_stream, session, channel));
  m_update_exchange.reset(
      new bm::net::game_update_exchange(*m_game_channel, player_count));
  m_contest_runner.reset(new bm::net::contest_runner(
...
void bm::app::console::online_game::schedule_tick()
{
...
void bm::app::console::online_game::tick()
{
