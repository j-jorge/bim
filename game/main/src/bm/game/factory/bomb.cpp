...
entt::entity bm::game::bomb_factory(entt::registry& registry, std::uint8_t x,
                                    std::uint8_t y, std::uint8_t strength)
{
  return bomb_factory(registry, x, y, 2, std::chrono::seconds(2));
}

entt::entity
bm::game::bomb_factory(entt::registry& registry, std::uint8_t x,
                       std::uint8_t y, std::uint8_t strength,
