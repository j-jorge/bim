...
{
  entt::registry registry;
  bim::game::player_factory(registry, 2, 0, 0);
...
{
  entt::registry registry;
  bim::game::player_factory(registry, 1, 0, 0);
  bim::game::player_factory(registry, 2, 0, 0);
...
{
  entt::registry registry;
  bim::game::player_factory(registry, 0, 0, 0);
  bim::game::player_factory(registry, 1, 0, 0);
  bim::game::player_factory(registry, 2, 0, 0);
...
TEST(bim_game_check_game_over, four_players)
{
  ...
  bim::game::player_factory(registry, 1, 0, 0);
  bim::game::player_factory(registry, 2, 0, 0);
  bim::game::player_factory(registry, 3, 0, 0);
...
TEST(bim_game_check_game_over, two_players_timeout)
{
  ...
  bim::game::contest_result result = bim::game::check_game_over(registry);
