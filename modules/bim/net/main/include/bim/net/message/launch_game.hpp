...
namespace bim::net
{
  ...
  public:
    ...
    launch_game(client_token request_token,
                iscool::net::channel_id game_channel, game_id gid,
                std::uint64_t seed, bim::game::feature_flags features,
