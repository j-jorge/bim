...
ic_implement_state_monitor(bm::net::new_game_exchange, m_monitor, idle,
                           ((idle)((start)))         //
                           ((start)((accept)(stop))) //
                           ((accept)((stop)))        //
                           ((stop)((idle))));

IMPLEMENT_SIGNAL(bm::net::new_game_exchange, game_proposal, m_game_proposal);
IMPLEMENT_SIGNAL(bm::net::new_game_exchange, launch_game, m_launch_game);

bm::net::new_game_exchange::new_game_exchange(
    iscool::net::message_stream& stream, iscool::net::session_id session)
  : m_message_channel(stream, session, 0)
{}

bm::net::new_game_exchange::~new_game_exchange() = default;

void bm::net::new_game_exchange::start(const game_name& name)
{
...
void bm::net::new_game_exchange::accept()
{
  assert(!!m_encounter_id);
...
void bm::net::new_game_exchange::stop()
{
...
void bm::net::new_game_exchange::tick()
{
...
void bm::net::new_game_exchange::check_on_hold(const game_on_hold& message)
{
...
void bm::net::new_game_exchange::check_launch_game(const launch_game& message)
{
