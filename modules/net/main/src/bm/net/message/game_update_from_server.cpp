...
bm::net::game_update_from_server::game_update_from_server() = default;

bm::net::game_update_from_server::game_update_from_server(
...
iscool::net::message bm::net::game_update_from_server::build_message() const
{
...
std::size_t bm::net::game_update_from_server::message_size() const
{
